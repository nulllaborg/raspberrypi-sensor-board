...
- When powered via DC or terminal block, the 3A current input can directly power the Raspberry Pi board, and the board does not require any additional external power supply.
- The switch is used to enable or disable the power input from the DC jack and the terminal block. Setting the switch to ON establishes the connection, while setting it to OFF interrupts the connection.
...
![select_option](./picture/picture1.png)
![select_i2c](./picture/picture2.png)
![i2c_enabled](./picture/picture3.png)
![comfirmed](./picture/picture4.png)
...
![view_i2c_address](./picture/picture5.png)
...
![display_i2c_address](./picture/picture6.png)
